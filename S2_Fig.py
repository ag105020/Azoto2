...
# #    rcParams.update({'marker.size': 10})
    ...
    Folderloc="Azoto2\\From_317_03_40_02"
   ...
   #OOOOOOOOO
    ...
    PRd[PRd<0]=nan
    figure(6)
    plot(CN,PRd/pr, linewidth=2.5, color=plotcolor)
    plot(buhler_data.cnBio, buhler_data.Bio,'o', color=plotcolor)
    xlabel(xname)
    ylabel('Biomass (mg/ml)')
    #title('Protein concentration in the vessel')
    xlim(xmax=Xlimmax)
    if buhler_data.i==buhler_data.imax:
        Savefig(Folderloc,6)
